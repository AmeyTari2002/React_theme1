  ...
  return (
    <>
      ...
      <div className=' items-center  justify-start mx-3 sm:mx-56 mt-5 text-2xl font-bold'>
        ...
        <div className='mt-4  grid grid-cols-3 sm:flex gap-3 '>
      ...
      <div className=' items-center mx-3 justify-start sm:mx-56 mt-4 text-2xl font-bold'>
        ...
        <div className='my-8 grid grid-cols-2 gap-2 sm:grid sm:grid-cols-4  sm:gap-7'>

          <div className=' h-48 w-56 sm:w-64 hover:scale-105'>
